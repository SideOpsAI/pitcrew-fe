...
export const contactLeadSchema = z
  .object({
    ...
    serviceInterest: z.string().trim().max(300).optional().or(z.literal("")),
    ...
    extraServiceKey: z.string().trim().max(240).optional().or(z.literal("")),
    extraServiceName: z.string().trim().max(300).optional().or(z.literal("")),
    extraServicePrice: z.string().trim().max(120).optional().or(z.literal("")),
    extraServiceDuration: z.string().trim().max(120).optional().or(z.literal("")),
    extraServiceDetails: z.string().trim().max(2000).optional().or(z.literal("")),
